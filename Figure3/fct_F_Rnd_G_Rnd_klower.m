function [maxpi_orig,locmax_orig,maxL_orig,maxGAMMA_orig,maxphi_orig,maxb_orig,maxpi_FOSD,maxL_FOSD,maxGAMMA_FOSD,...
    maxphi_FOSD,maxb_FOSD,is_FOSD_Larger,Welfare_orig,Welfare_FOSD,diff_avg_orig,diff_avg_FOSD,klower_orig,klower_FOSD]=fct_F_Rnd_G_Rnd_klower(n,lambdag,lambdagfosd,betaa)
...
all_klow=kmin_orig_f:1:kmax_orig_f;
...
klower_orig=all_klow(locmax_orig);

all_klow=kmin_FOSD_f:1:kmax_FOSD_f;
...
klower_FOSD=all_klow(locmax_FOSD);
